...
const Title = () => (
  <a href="/">
    <img className="logo" src="https://static.vecteezy.com/system/resources/thumbnails/011/468/885/small/food-logo-spoon-fork-icon-illustration-symbol-for-fast-delivery-app-restaurant-template-free-vector.jpg" alt="Food Fire Logo" />
  </a>
);
...
const Footer = () => {
  ...
  return (
    <div className="footer">
      ...
      <a href="https://www.linkedin.com/in/abhishek-tyagi14/" target="_blank">
        Abhishek Tyagi
      </a>
